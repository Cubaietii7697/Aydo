...
inline constexpr std::wstring_view SYSMON_ENABLED_CONSOLE_MSG = L"Sysmon provider: enabled";
inline constexpr std::wstring_view SYSMON_DISABLED_CONSOLE_MSG = L"Sysmon provider: unavailable";
inline constexpr auto TARGET_PID_REFRESH_INTERVAL = std::chrono::milliseconds(1000);
inline constexpr const char *SYSMON_UNAVAILABLE_MSG = "ProcessMonitor: Sysmon provider unavailable; continuing without Sysmon\n";
